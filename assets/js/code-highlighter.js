function Parser(themenum, transparent) {
    function Elments() {
      var d = document;
      var New = null;
      newed = false;
    ...
    function Neutraliser() {
      ...
      this.cc = function () {
        return curentN_count;
      };
      this.text = function (str) {
        curentString.push(str);
        return (
          '<span class="N-not-trusted" id="N-not-trusted' +
          (curentString.length - 1) /*-'+curentN_count+*/ +
          '"></span>'
        );
      };
    ...
    function theme() {
      Theme = {
        str: "rgb(179, 66, 37)",
        cm: "rgb(85, 179, 85)",
        bg: !transparent ? "#03111b" : "transparent",
        k1: "#1168cc",
        k2: "#80468f",
        k3: "#85d6eb",
        k4: "rgb(238, 225, 151)",
      ...
      switch (themenum) {
        case 1:
          Theme = {
            str: "#de5926",
            cm: "gray",
            bg: !transparent ? "#100d25" : "transparent",
            k1: "#14abf3",
            k2: "#fd0ab2",
            k3: "#07ffff",
            k4: "#f1d433",
        ...
        case 4:
          ...
          Theme = {
            str: "rgb(179, 66, 37)",
            cm: "#8a7564",
            bg: !transparent ? "rgba(27, 31, 35, 0.051)":"transparent",
            k1: "#4b65af",
            k2: "#80468f",
            k3: "#9dad6e",
            k4: "#cc875d",
        ...
        case 3:
          ...
          Theme = {
            ...
            k1: "rgb(179, 66, 37)",
            k2: "#80468f",
            k3: "rgba(218, 216, 216, 0.877)",
            k4: "#9dad6e",
            sp: "rgba(218, 216, 216, 0.877)",
            n: "rgba(218, 216, 216, 0.877)",
          };
          break;
      }
    }
    ...
    var inreptag1 =
      getString(2519) + getString(598) + getString(721) + getString(1940);
    var inreptag2 =
      getString(902) + getString(1193) + getString(1447) + getString(889);
    var newllnne =
      getString(2902) +
      getString(1003) +
      getString(447) +
      ...
      if (null !== codes) {
        ...
        for (i = 0; i < txts.length; i++) {
          if (txts[i] !== "" && txts[i] !== inreptag1) {
            ...
            toEditor(
              /*Elems.Class("mdcode-inline")[curct]*/ div,
              codes[j],
              "js",
              true
            );
        ...
        if (null !== codes) {
          ...
          if (null !== codes) {
            ...
            if (null !== codes) {
              ...
              } else if (s.includes(newllnne)) {
                //<<link=https://google.com/fgfugtkgg/frirjgt/igyg?aps=jfufugughghj&kj=jfjhrdtf>>Google<<link>>
                ...
                if (null !== codes) {
                  ...
                  for (i = 0; i < txts.length; i++) {
                    if (txts[i] !== "" && txts[i] !== inreptag1) {
                      ...
                      obj.innerHTML +=
                        '<a target="_blank" rel="noopener" id="in-line-llinkks"></a>';
    ...
    var mCommentReplacer =
      getString(2467) + getString(993) + getString(1535) + getString(967);
    var sCommentReplacer =
      getString(489) + getString(2328) + getString(1921) + getString(962);
    var dStrinReplacer =
      getString(647) + getString(1246) + getString(769) + getString(1979);
    var mComOut1 =
      getString(728) + getString(923) + getString(1829) + getString(415);
    var mComOut2 =
      getString(798) + getString(1423) + getString(647) + getString(829);
    var sComOut =
      getString(902) + getString(1193) + getString(1447) + getString(889);
    var lnBreaks =
      getString(1678) + getString(923) + getString(503) + getString(691);
    var clsTags =
      getString(2819) + getString(528) + getString(1621) + getString(640);
    var clsTagss =
      getString(2519) + getString(598) + getString(721) + getString(1940);
  
    var _atCodeTextValue =
      getString(1759) + getString(98) + getString(2241) + getString(70);
    var atCodeTexts = function (i) {
      return _atCodeTextValue;
      // return (
      //   getString(1759) + getString(98 + i) + getString(2241) + getString(70)
      // );
    };
    ...
    function toEditor(obj, s, lang, inline) {
      ...
      s = " " + s + "\n";
      var ui,
        plainTexts = s.match(/<@text>.*?<@text>/gs);
      if (plainTexts) {
        s = s.replace(/<@text>.*?<@text>/gs, atCodeTexts(0));
        for (ui = 0; ui < plainTexts.length; ui++) {
          plainTexts[ui] = plainTexts[ui].replace(/<@text>/gs, "");
        }
      }
      var ij,
        ii,
        x,
        curr = getString(287 + i);
      s = s.replace(RegExp("\n", "g"), "\n ");
      s = s.replace(RegExp("\n", "g"), lnBreaks);
  
      var dStrings = s.match(/"([^"]*)"/g),
        dStringss;
      var wxcp = "+?/)(*][&$|\\^.";
      if (null !== dStrings) {
      ...
      if (null !== singleC) {
        ...
        if (inline) {
          s = s.replace(RegExp("\n", "g"), "");
          singleC[0] = singleC[0].replace(RegExp("\n", "g"), "");
        }
        for (j in singleC) {
          singls = singleC[j];
          ...
          if (null !== multiC) {
            for (ii = 0; ii < multiC.length; ii++) {
              singleC[j] = singleC[j].replace(
                mCommentReplacer + getString(634 + ii),
                multiC[ii]
              );
            }
          }
      ...
      if (null !== dStrings) {
        ...
        for (j in dStrings) {
          ...
          s = s.replace(
            RegExp(dStringss, "g"),
            dStrinReplacer + getString(634 + x)
          );
          x++;
        }
      }
      ...
      switch (lang) {
        ...
        case "js":
          ...
          spkwords2 = ["with", "finally", "package", "import", "as", "await", "from"];
          lang = ".js";
          break;
        default:
          lang = "def";
      ...
      for (j in gkwords1) {
        hts =
          getString(772) + getString(993) + getString(278 + j) + getString(3219);
        for (ii = 0; ii < wChars.length - 1; ii++) {
          ...
          for (w = 0; w < wChars.length; w++) {
            ...
            s = s.replace(
              RegExp(wh1 + gkwords1[j] + wh2, "g"),
              wChars[ii] + hts + wChars[w]
            );
          }
        }
      }
      for (j in gkwords2) {
        hts =
          getString(801) + getString(762) + getString(483 + j) + getString(319);
        for (ii = 0; ii < wChars.length - 1; ii++) {
          wh1 = wChars[ii];
          if (wxcpe.includes(wh1)) {
            wh1 = "\\" + wh1;
      ...
      for (j in spkwords2) {
        hts =
          getString(1801) + getString(2762) + getString(513 + j) + getString(459);
        for (ii = 0; ii < wChars.length - 1; ii++) {
          wh1 = wChars[ii];
          if (wxcpe.includes(wh1)) {
            wh1 = "\\" + wh1;
      ...
      for (j in spkwords1) {
        hts =
          getString(281) + getString(662) + getString(411 + j) + getString(1459);
        for (ii = 0; ii < wChars.length - 1; ii++) {
          wh1 = wChars[ii];
          if (wxcpe.includes(wh1)) {
            wh1 = "\\" + wh1;
      ...
      var numbstr =
        getString(874) + getString(7777) + getString(1877) + getString(177);
      function repChars(str, curNum) {
        ...
        for (i in chars) {
          for (j in chars) {
            strlrn = str;
            str = str.replace(
              chars[i] + curNum + chars[j],
              chars[i] +
                numbstr +
                'span class="mdnumbers mdnumbs' +
                curr +
                '">' +
                curNum +
                numbstr +
      ...
      s = s.replace(
        RegExp("<", "g"),
        '<span class="mdspchars mdspch' + curr + '"><</span>'
      );
      s = s.replace(RegExp(numbstr, "g"), "<");
      s = s.replace(
        RegExp(clsTags, "g"),
        '<span class="mdspchars mdspch' +
          curr +
          '"><</span><span class="mdspchars mdspch' +
          curr +
          '">/</span>'
      );
      if (null !== multiC) {
        for (ii = 0; ii < multiC.length; ii++) {
          s = s.replace(
            RegExp(mCommentReplacer + getString(634 + ii), "g"),
            '<span class="mdcomments mdnotrust' +
              curr +
              'mC">' +
              getString(634 + ii) +
              "</span>"
      ...
      if (null !== singleC) {
        for (ii = 0; ii < singleC.length; ii++) {
          s = s.replace(
            RegExp(sCommentReplacer + getString(634 + ii), "g"),
            '<span class="mdcomments mdnotrust' +
              curr +
              'sC">' +
              getString(634 + ii) +
      ...
      if (null !== dStrings) {
        for (ii = 0; ii < dStrings.length; ii++) {
          s = s.replace(
            RegExp(dStrinReplacer + getString(634 + ii), "g"),
            '<span class="mdstrings mdnotrust' +
              curr +
              'dS">' +
              getString(634 + ii) +
              "</span>"
      ...
      for (j in htmlTags) {
        hts =
          getString(902) + getString(1193) + getString(346 + j) + getString(889);
        s = s.replace(
          RegExp(hts, "g"),
          '<span class="mdkeywordi mdkeywords' +
            curr +
            'i">' +
            htmlTags[j] +
            "</span>"
      ...
      for (j in gkwords2) {
        ...
        s = s.replace(
          RegExp(hts, "g"),
          '<span class="mdkeywordii mdkeywords' +
            curr +
            'ii">' +
            gkwords2[j] +
            "</span>"
      ...
      var incont, //= s.match(/\/span>(.*?)<span/g),
        infunc,
        funchold = [],
        inconthold,
        wChars = [
      ...
      for (ii = 0; ii < Wcharss.length; ii++) {
        s = s.replace(
          RegExp(Wcharss[ii], "g"),
          '<span class="mdspchars mdspch' + curr + '">' + wCharss[ii] + "</span>"
        );
      }
      ...
      if (null !== incont) {
        ...
        for (x = 0; x < incont.length; x++) {
          ...
          inconthold = inconthold.replace(
            RegExp("\\/", "g"),
            "<span class" + clsTagss + '"mdspchars mdspch' + curr + '">/</span>'
          );
          inconthold = inconthold.replace(
            RegExp("=", "g"),
            '<span class="mdspchars mdspch' + curr + '">=</span>'
      ...
      if (null !== incont) {
        for (x = 0; x < incont.length; x++) {
          otstr = "";
          infunc = incont[x];
          if (infunc.indexOf(atCodeTexts(0)) >= 0) {
            OtOfHold.push(incont[x]);
            continue;
          }
          ...
          for (ii = 0; ii < infunc.length - 1; ii++) {
            ...
            if (infunc[ii].length > 0) {
              ...
              if (ofspce === " ") {
                ...
                otstr +=
                  '<span class="mdkeywordiii mdnotrust' +
                  curr +
                  'ot">' +
                  getString(634 + others.indexOf(ofspce)) +
                  "</span>";
              }
            }
            infunc[ii] = ofspce2;
            ...
            otstr +=
              '<span class="mdkeywordiv mdnotrust' +
              curr +
              'ff">' +
              getString(634 + ofhold.indexOf(infunc[ii])) +
              '</span><span class="mdspchars mdspch' +
              curr +
              '">(</span>';
          }
          if (infunc[infunc.length - 1] !== "") {
            if (infunc[infunc.length - 1] === " ") {
              ...
              otstr +=
                ...
                curr +
                'ot">' +
                getString(634 + others.indexOf(infunc[infunc.length - 1])) +
                "</span>";
            }
          }
      ...
      if (null != plainTexts) {
        s = s.replace(
          RegExp(atCodeTexts(0), "g"),
          '<code class="mdtexts mdnotrust' + curr + 'pT">' + "</code>"
        );
        // for (ui = 0; ui < plainTexts.length; ui++){
        //   s = s.replace(atCodeTexts(ui), '<code class="mdtexts mdnotrust' + curr + 'pT">' + '</code>');
        // }
        //s = s.replace()
      }
      var markdown;
      if (!inline) {
        ...
        markdown = Elems.new("pre")
          .attri("class", "markdown")
          .attri("id", "md2-uv3fsxh1-m")
          .get();
        ...
        Elems.targ(markdown).html(s); //#100d25
        ...
        markdown = Elems.new("span")
          .attri("class", "markdown-inline")
          .attri("id", "md1-uv3brxh2-m")
          .get();
      ...
      var pTexts = Elems.Class("mdnotrust" + curr + "pT", markdown);
      if (cmM !== null) {
      ...
      if (cmS !== null) {
        for (ii = 0; ii < cmS.length; ii++) {
          cmS[ii].textContent = singleC[cmS[ii].textContent.charCodeAt(0) - 634]
            .replace(RegExp(mComOut2, "g"), "*/")
            .replace(RegExp(mComOut1, "g"), "/*")
      ...
      if (fncS !== null) {
        for (ii = 0; ii < fncS.length; ii++) {
          fncS[ii].textContent =
            funchold[fncS[ii].textContent.charCodeAt(0) - 634];
          fncS[ii].style.color = Theme.k4;
        }
      }
      if (fncS2 !== null) {
        for (ii = 0; ii < fncS2.length; ii++) {
          fncS2[ii].textContent =
            ofhold[fncS2[ii].textContent.charCodeAt(0) - 634];
      ...
      if (pTexts !== null && plainTexts) {
        for (ii = 0; ii < pTexts.length; ii++) {
          pTexts[ii].textContent = plainTexts[ii];
        }
      }
    ...
    function copyLikes(n) {
      return (
        '<button class="mdcopybut md-xzcpys1-xc" id="md-xzcpys1-xc">' +
        (n === 1
          ? copppie +
            '</button><span class="mdcopytip md-ljcpy0i-zc" id="md-ljcpy0i-zc">Copied</span>'
          : maxicon + "</button>")
      );
    }
    this.toEditor = toEditor;
    this.inlineMix = editInline;
    this.theme = function (thme, trns) {
      themenum = thme;
      transparent = trns;
      theme();
    };
